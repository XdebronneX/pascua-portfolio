...
import { SiTailwindcss, SiMongodb, SiLaravel, SiPrimereact, SiVercel, SiExpress, SiMysql, SiPostman, SiMongoose, SiCloudinary, SiWebpack, SiNpm, SiPrettier, SiInsomnia, SiRender, SiVite, SiDotenv, SiSwagger, SiGithubpages } from "react-icons/si";
import { DiVisualstudio } from "react-icons/di";
import { BiSolidCylinder } from "react-icons/bi";
const skills = [
    ...
    { name: "TailwindCSS", icon: <SiTailwindcss className="text-cyan-500 text-6xl" /> },
    { name: "Bootstrap", icon: <FaBootstrap className="text-purple-600 text-6xl" /> },
    { name: "PrimeReact", icon: <SiPrimereact className="text-blue-500 text-6xl" /> },
    ...
    { name: "Mongoose", icon: <SiMongoose className="text-green-500 text-6xl" /> },
    { name: "PHP Laravel", icon: <SiLaravel className="text-red-500 text-6xl" /> },
    { name: "MySQL", icon: <SiMysql className="text-blue-600 text-6xl" /> },
    { name: "Microsoft SQL Server", icon: <BiSolidCylinder className="text-yellow-500 text-6xl" /> },
    { name: "MySQL Workbench", icon: <SiMysql className="text-blue-500 text-6xl" /> },
    { name: "XAMPP", icon: <FaServer className="text-orange-500 text-6xl" /> },
    { name: "WAMP", icon: <FaServer className="text-green-500 text-6xl" /> },
    { name: "Draw.io", icon: <FaProjectDiagram className="text-orange-500 text-6xl" /> },
    { name: "Git", icon: <FaGit className="text-red-500 text-6xl" /> },
    { name: "GitHub", icon: <FaGithub className="text-gray-700 text-6xl" /> },
    { name: "Vite", icon: <SiVite className="text-purple-500 text-5xl" /> },
    { name: "Webpack", icon: <SiWebpack className="text-blue-500 text-6xl" /> },
    { name: "NPM", icon: <SiNpm className="text-red-600 text-6xl" /> },
    { name: "DotEnv", icon: <SiDotenv className="text-yellow-400 text-5xl" /> },
    { name: "Prettier", icon: <SiPrettier className="text-yellow-500 text-6xl" /> },
    { name: "Postman", icon: <SiPostman className="text-orange-500 text-6xl" /> },
    { name: "Insomnia", icon: <SiInsomnia className="text-purple-500 text-6xl" /> },
    { name: "Swagger", icon: <SiSwagger className="text-green-500 text-6xl" /> },
    { name: "Cursor", icon: <FaCube className="text-gray-700 text-6xl" /> },
    { name: "VSCode", icon: <DiVisualstudio className="text-blue-500 text-6xl" /> },
    { name: "Cloudinary", icon: <SiCloudinary className="text-blue-500 text-6xl" /> },
    { name: "Vercel", icon: <SiVercel className="text-gray-700 text-6xl" /> },
    { name: "Render", icon: <SiRender className="text-blue-400 text-6xl" /> },
    { name: "GitHub Pages", icon: <SiGithubpages className="text-gray-700 text-6xl" /> },
];
        ...
        <div id="technologies" className="p-8 text-center bg-gray-900 text-white">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8">
                {skills.map((skill, index) => (
                    ...
                    >
                        <Card className="shadow-md bg-gray-800 p-6 rounded-lg flex flex-col items-center">
